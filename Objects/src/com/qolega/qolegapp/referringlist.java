...
final anywheresoftware.b4a.BA.IterableList group64 = _reference;
final int groupLen64 = group64.getSize();
for (int index64 = 0;index64 < groupLen64 ;index64++){
_colreference.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(group64.Get(index64)));
