...
public static String  _activity_actionbarhomeclick() throws Exception{
 //BA.debugLineNum = 225;BA.debugLine="Sub Activity_ActionBarHomeClick";
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 28;BA.debugLine="font.Initialize";
mostCurrent._font._initialize(processBA);
 //BA.debugLineNum = 31;BA.debugLine="Activity.Title = \"Candidate Progress\"";
...
mostCurrent._container.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 34;BA.debugLine="Container.Color = Colors.RGB(245,245,245)";
mostCurrent._container.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (245),(int) (245),(int) (245)));
 //BA.debugLineNum = 35;BA.debugLine="Activity.AddView(Container,0,0,100%x,100%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._container.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 37;BA.debugLine="bar.Initialize(\"bar\")";
mostCurrent._bar.Initialize("bar",mostCurrent.activityBA);
 //BA.debugLineNum = 38;BA.debugLine="bar.ShowUpIndicator = True";
mostCurrent._bar.setShowUpIndicator(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 40;BA.debugLine="detailList.Initialize";
mostCurrent._detaillist.Initialize();
 //BA.debugLineNum = 41;BA.debugLine="LoopPanel";
_looppanel();
...
public static boolean  _areequal(int _b1,int _b2) throws Exception{
 //BA.debugLineNum = 319;BA.debugLine="Sub AreEqual(b1 As Int, b2 As Int) As Boolean";
 //BA.debugLineNum = 320;BA.debugLine="If b1 <> b2 Then Return False";
if (_b1!=_b2) { 
...
anywheresoftware.b4a.objects.LabelWrapper _utiltextlabel = null;
 //BA.debugLineNum = 279;BA.debugLine="Sub closeIcon_Click";
 //BA.debugLineNum = 280;BA.debugLine="Dim detailPanel,jobTitlePanel,journeyPanel As Pan";
...
_journeypanel = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 281;BA.debugLine="Dim utilTextLabel As Label";
_utiltextlabel = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 283;BA.debugLine="detailPanel = detailList.Get(0)";
_detailpanel.setObject((android.view.ViewGroup)(mostCurrent._detaillist.Get((int) (0))));
 //BA.debugLineNum = 284;BA.debugLine="utilTextLabel = detailList.Get(1)";
_utiltextlabel.setObject((android.widget.TextView)(mostCurrent._detaillist.Get((int) (1))));
 //BA.debugLineNum = 285;BA.debugLine="jobTitlePanel = detailList.Get(2)";
_jobtitlepanel.setObject((android.view.ViewGroup)(mostCurrent._detaillist.Get((int) (2))));
 //BA.debugLineNum = 286;BA.debugLine="journeyPanel = detailList.Get(3)";
_journeypanel.setObject((android.view.ViewGroup)(mostCurrent._detaillist.Get((int) (3))));
 //BA.debugLineNum = 288;BA.debugLine="detailPanel.Height = detailPanel.Height - 100dip";
_detailpanel.setHeight((int) (_detailpanel.getHeight()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100))));
 //BA.debugLineNum = 289;BA.debugLine="utilTextLabel.Top = detailPanel.Height";
_utiltextlabel.setTop(_detailpanel.getHeight());
 //BA.debugLineNum = 290;BA.debugLine="utilTextLabel.Text = \"Show candidate details\"";
_utiltextlabel.setText((Object)("Show candidate details"));
 //BA.debugLineNum = 291;BA.debugLine="jobTitlePanel.Top = utilTextLabel.Top + utilTextL";
_jobtitlepanel.setTop((int) (_utiltextlabel.getTop()+_utiltextlabel.getHeight()));
 //BA.debugLineNum = 292;BA.debugLine="scrollView.Top = jobTitlePanel.Top + jobTitlePane";
mostCurrent._scrollview.setTop((int) (_jobtitlepanel.getTop()+_jobtitlepanel.getHeight()));
 //BA.debugLineNum = 293;BA.debugLine="journeyPanel.Height = journeyPanel.Height - jobTi";
_journeypanel.setHeight((int) (_journeypanel.getHeight()-_jobtitlepanel.getTop()+_jobtitlepanel.getHeight()));
 //BA.debugLineNum = 298;BA.debugLine="showIcon.Visible = True";
mostCurrent._showicon.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 299;BA.debugLine="closeIcon.Visible = False";
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper _cvsmain = null;
 //BA.debugLineNum = 303;BA.debugLine="Sub DrawDashLine(Target As View,x1 As Float, y1 As";
 //BA.debugLineNum = 304;BA.debugLine="Dim p As ABPaint";
_p = new com.AB.ABExtDrawing.ABExtDrawing.ABPaint();
 //BA.debugLineNum = 305;BA.debugLine="Dim ExtDrawing As ABExtDrawing";
_extdrawing = new com.AB.ABExtDrawing.ABExtDrawing();
 //BA.debugLineNum = 306;BA.debugLine="Dim cvsMain As Canvas";
_cvsmain = new anywheresoftware.b4a.objects.drawable.CanvasWrapper();
 //BA.debugLineNum = 308;BA.debugLine="cvsMain.Initialize(Target)";
_cvsmain.Initialize((android.view.View)(_target.getObject()));
 //BA.debugLineNum = 310;BA.debugLine="p.Initialize";
_p.Initialize();
 //BA.debugLineNum = 311;BA.debugLine="p.SetStrokeWidth(Stroke)";
_p.SetStrokeWidth(_stroke);
 //BA.debugLineNum = 312;BA.debugLine="p.SetStyle(p.Style_STROKE)";
_p.SetStyle(_p.Style_STROKE);
 //BA.debugLineNum = 313;BA.debugLine="p.SetColor(col)";
_p.SetColor(_col);
 //BA.debugLineNum = 314;BA.debugLine="p.SetDashPathEffect(1, Array As Float(2dip, 2d";
_p.SetDashPathEffect((int) (1),new float[]{(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))),(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)))},(float) (0));
 //BA.debugLineNum = 315;BA.debugLine="p.DoPathEffectSingle(1)";
_p.DoPathEffectSingle((int) (1));
 //BA.debugLineNum = 316;BA.debugLine="ExtDrawing.DrawLine(cvsMain, x1, y1, x2, y2, p";
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper.PathWrapper _path1 = null;
 //BA.debugLineNum = 237;BA.debugLine="Public Sub DrawLeftBorder(Target As View, aColor A";
 //BA.debugLineNum = 238;BA.debugLine="Dim c As Canvas";
_c = new anywheresoftware.b4a.objects.drawable.CanvasWrapper();
 //BA.debugLineNum = 239;BA.debugLine="c.Initialize(Target)";
_c.Initialize((android.view.View)(_target.getObject()));
 //BA.debugLineNum = 240;BA.debugLine="Dim Path1 As Path";
_path1 = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.PathWrapper();
 //BA.debugLineNum = 241;BA.debugLine="Path1.Initialize(0,0)";
_path1.Initialize((float) (0),(float) (0));
 //BA.debugLineNum = 243;BA.debugLine="If Last == True Then";
if (_last==anywheresoftware.b4a.keywords.Common.True) { 
 }else {
 //BA.debugLineNum = 246;BA.debugLine="If Single == True Then";
if (_single==anywheresoftware.b4a.keywords.Common.True) { 
 }else {
 //BA.debugLineNum = 249;BA.debugLine="Path1.LineTo(0,Target.Height)";
_path1.LineTo((float) (0),(float) (_target.getHeight()));
 };
 };
 //BA.debugLineNum = 253;BA.debugLine="c.DrawPath(Path1, aColor, False, StrokeWidth)";
_c.DrawPath((android.graphics.Path)(_path1.getObject()),_acolor,anywheresoftware.b4a.keywords.Common.False,(float) (_strokewidth));
 //BA.debugLineNum = 254;BA.debugLine="Target.Invalidate";
_target.Invalidate();
...
mostCurrent._detaillist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 24;BA.debugLine="Dim showIcon,closeIcon As ImageView";
...
anywheresoftware.b4a.objects.drawable.ColorDrawable _cd = null;
 //BA.debugLineNum = 44;BA.debugLine="Sub LoopPanel";
 //BA.debugLineNum = 45;BA.debugLine="Dim jobTitlePanel,detailPanel,journeyPanel,refere";
_jobtitlepanel = new anywheresoftware.b4a.objects.PanelWrapper();
_detailpanel = new anywheresoftware.b4a.objects.PanelWrapper();
_journeypanel = new anywheresoftware.b4a.objects.PanelWrapper();
_referencepanel = new anywheresoftware.b4a.objects.PanelWrapper();
_progressbox = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 46;BA.debugLine="Dim PanelTop,IconTop,PanelHeight,ReferenceTop,Ref";
_paneltop = 0;
_icontop = 0;
_panelheight = 0;
_referencetop = 0;
...
_gap = 0;
_textheight = 0;
 //BA.debugLineNum = 47;BA.debugLine="Dim jobTitle,utilText,refName,refCompany,refStatu";
...
_detailbtn = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 48;BA.debugLine="Dim userIcon As ImageView";
_usericon = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 51;BA.debugLine="JSON.Initialize(File.ReadString(File.DirAssets";
mostCurrent._json.Initialize(anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"status_reference.json"));
 //BA.debugLineNum = 52;BA.debugLine="Dim root As Map = JSON.NextObject";
_root = new anywheresoftware.b4a.objects.collections.Map();
_root = mostCurrent._json.NextObject();
 //BA.debugLineNum = 54;BA.debugLine="Dim dataName As String = root.Get(\"name\")";
_dataname = BA.ObjectToString(_root.Get((Object)("name")));
 //BA.debugLineNum = 55;BA.debugLine="Dim dataCompany As String = root.Get(\"company\")";
_datacompany = BA.ObjectToString(_root.Get((Object)("company")));
 //BA.debugLineNum = 56;BA.debugLine="Dim dataJobtitle As String = root.Get(\"jobtitle\")";
_datajobtitle = BA.ObjectToString(_root.Get((Object)("jobtitle")));
 //BA.debugLineNum = 59;BA.debugLine="PanelTop = 10dip";
_paneltop = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10));
 //BA.debugLineNum = 61;BA.debugLine="PanelHeight = 110dip";
_panelheight = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110));
 //BA.debugLineNum = 63;BA.debugLine="Gap = 10dip";
_gap = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10));
 //BA.debugLineNum = 65;BA.debugLine="detailPanel.Initialize(\"\")";
_detailpanel.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 66;BA.debugLine="detailPanel.Color = Colors.White";
_detailpanel.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 67;BA.debugLine="Container.AddView(detailPanel,0,10dip,100%x,80dip";
mostCurrent._container.AddView((android.view.View)(_detailpanel.getObject()),(int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (80)));
 //BA.debugLineNum = 71;BA.debugLine="userIcon.Initialize(\"\")";
_usericon.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 72;BA.debugLine="userIcon.Bitmap = LoadBitmap(File.DirAssets,\"user";
_usericon.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"user.png").getObject()));
 //BA.debugLineNum = 73;BA.debugLine="userIcon.Gravity = Gravity.FILL";
_usericon.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 74;BA.debugLine="refName.Initialize(\"\")";
_refname.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 75;BA.debugLine="refName.Text = dataName";
_refname.setText((Object)(_dataname));
 //BA.debugLineNum = 76;BA.debugLine="refName.TextColor = Colors.RGB(74,74,74)";
_refname.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (74),(int) (74),(int) (74)));
 //BA.debugLineNum = 78;BA.debugLine="refName.Typeface = font.proximanovaSemiBold";
_refname.setTypeface((android.graphics.Typeface)(mostCurrent._font._proximanovasemibold().getObject()));
 //BA.debugLineNum = 80;BA.debugLine="detailPanel.AddView(userIcon,10dip,10dip,24dip,24";
_detailpanel.AddView((android.view.View)(_usericon.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (24)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (24)));
 //BA.debugLineNum = 81;BA.debugLine="detailPanel.AddView(refName,38dip,12dip,detailPan";
_detailpanel.AddView((android.view.View)(_refname.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (38)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (12)),(int) (_detailpanel.getWidth()-(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (38))*2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)));
 //BA.debugLineNum = 84;BA.debugLine="refCompany.Initialize(\"\")";
_refcompany.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 85;BA.debugLine="refCompany.Text = dataCompany";
_refcompany.setText((Object)(_datacompany));
 //BA.debugLineNum = 86;BA.debugLine="refCompany.TextColor = Colors.RGB(179,179,179)";
_refcompany.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (179),(int) (179),(int) (179)));
 //BA.debugLineNum = 88;BA.debugLine="refCompany.Typeface = font.proximanovaRegular";
_refcompany.setTypeface((android.graphics.Typeface)(mostCurrent._font._proximanovaregular().getObject()));
 //BA.debugLineNum = 89;BA.debugLine="detailPanel.AddView(refCompany,38dip,refName.Top+";
_detailpanel.AddView((android.view.View)(_refcompany.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (38)),(int) (_refname.getTop()+_refname.getHeight()),(int) (_detailpanel.getWidth()-(38*2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)));
 //BA.debugLineNum = 92;BA.debugLine="detailList.Add(detailPanel)";
mostCurrent._detaillist.Add((Object)(_detailpanel.getObject()));
 //BA.debugLineNum = 95;BA.debugLine="showIcon.Initialize(\"showIcon\")";
mostCurrent._showicon.Initialize(mostCurrent.activityBA,"showIcon");
 //BA.debugLineNum = 96;BA.debugLine="showIcon.Bitmap = LoadBitmap(File.DirAssets,\"Show";
mostCurrent._showicon.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Show.png").getObject()));
 //BA.debugLineNum = 97;BA.debugLine="showIcon.Gravity = Gravity.FILL";
mostCurrent._showicon.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 98;BA.debugLine="Container.AddView(showIcon,(detailPanel.Width/2)-";
mostCurrent._container.AddView((android.view.View)(mostCurrent._showicon.getObject()),(int) ((_detailpanel.getWidth()/(double)2)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (15))),(int) (_detailpanel.getHeight()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 101;BA.debugLine="closeIcon.Initialize(\"closeIcon\")";
mostCurrent._closeicon.Initialize(mostCurrent.activityBA,"closeIcon");
 //BA.debugLineNum = 102;BA.debugLine="closeIcon.Bitmap = LoadBitmap(File.DirAssets,\"Clo";
mostCurrent._closeicon.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Close.png").getObject()));
 //BA.debugLineNum = 103;BA.debugLine="closeIcon.Visible = False";
mostCurrent._closeicon.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 104;BA.debugLine="closeIcon.Gravity = Gravity.FILL";
mostCurrent._closeicon.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 105;BA.debugLine="Container.AddView(closeIcon,(detailPanel.Width/2)";
mostCurrent._container.AddView((android.view.View)(mostCurrent._closeicon.getObject()),(int) ((_detailpanel.getWidth()/(double)2)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (15))),(int) (_detailpanel.getHeight()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 107;BA.debugLine="Dim utilTextW As Int = 100dip";
_utiltextw = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100));
 //BA.debugLineNum = 110;BA.debugLine="utilText.Initialize(\"\")";
_utiltext.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 111;BA.debugLine="Container.AddView(utilText,0,detailPanel.Height,1";
mostCurrent._container.AddView((android.view.View)(_utiltext.getObject()),(int) (0),_detailpanel.getHeight(),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (70)));
 //BA.debugLineNum = 112;BA.debugLine="utilText.TextColor = Colors.RGB(179,179,179)";
_utiltext.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (179),(int) (179),(int) (179)));
 //BA.debugLineNum = 113;BA.debugLine="utilText.Text = \"Show candidate details\"";
_utiltext.setText((Object)("Show candidate details"));
 //BA.debugLineNum = 114;BA.debugLine="utilText.Gravity = Gravity.CENTER";
_utiltext.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 117;BA.debugLine="detailList.Add(utilText)";
mostCurrent._detaillist.Add((Object)(_utiltext.getObject()));
 //BA.debugLineNum = 121;BA.debugLine="jobTitlePanel.Initialize(\"\")";
_jobtitlepanel.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 122;BA.debugLine="Container.AddView(jobTitlePanel,0,(detailPanel.He";
mostCurrent._container.AddView((android.view.View)(_jobtitlepanel.getObject()),(int) (0),(int) ((_detailpanel.getHeight()+_utiltext.getHeight())-_gap),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100)));
 //BA.debugLineNum = 123;BA.debugLine="jobTitlePanel.Color = Colors.White";
_jobtitlepanel.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 126;BA.debugLine="detailList.Add(jobTitlePanel)";
mostCurrent._detaillist.Add((Object)(_jobtitlepanel.getObject()));
 //BA.debugLineNum = 128;BA.debugLine="jobTitle.Initialize(\"\")";
_jobtitle.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 129;BA.debugLine="jobTitle.Text = \"Referal Progress for \"&dataJobti";
_jobtitle.setText((Object)("Referal Progress for "+_datajobtitle));
 //BA.debugLineNum = 131;BA.debugLine="jobTitle.TextColor = Colors.RGB(74,74,74)";
_jobtitle.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (74),(int) (74),(int) (74)));
 //BA.debugLineNum = 132;BA.debugLine="jobTitlePanel.AddView(jobTitle,10dip,6dip,jobTitl";
_jobtitlepanel.AddView((android.view.View)(_jobtitle.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (6)),(int) (_jobtitlepanel.getWidth()-(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))*2)),_jobtitlepanel.getHeight());
 //BA.debugLineNum = 133;BA.debugLine="Dim titleHeight As Int";
_titleheight = 0;
 //BA.debugLineNum = 134;BA.debugLine="titleHeight = su.MeasureMultilineTextHeight(jobTi";
_titleheight = mostCurrent._su.MeasureMultilineTextHeight((android.widget.TextView)(_jobtitle.getObject()),_jobtitle.getText());
 //BA.debugLineNum = 136;BA.debugLine="jobTitlePanel.Height = titleHeight + 20dip";
_jobtitlepanel.setHeight((int) (_titleheight+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20))));
 //BA.debugLineNum = 138;BA.debugLine="scrollView.Initialize(Activity.Height)";
mostCurrent._scrollview.Initialize(mostCurrent.activityBA,mostCurrent._activity.getHeight());
 //BA.debugLineNum = 139;BA.debugLine="scrollView.Color = Colors.White";
mostCurrent._scrollview.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 140;BA.debugLine="Container.AddView(scrollView,0,(detailPanel.Heigh";
mostCurrent._container.AddView((android.view.View)(mostCurrent._scrollview.getObject()),(int) (0),(int) ((_detailpanel.getHeight()+_utiltext.getHeight()+_jobtitlepanel.getHeight()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 141;BA.debugLine="journeyPanel = scrollView.Panel";
_journeypanel = mostCurrent._scrollview.getPanel();
 //BA.debugLineNum = 144;BA.debugLine="detailList.Add(journeyPanel)";
mostCurrent._detaillist.Add((Object)(_journeypanel.getObject()));
 //BA.debugLineNum = 146;BA.debugLine="Dim referenceWrapper As Panel";
_referencewrapper = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 147;BA.debugLine="referenceWrapper.Initialize(\"\")";
_referencewrapper.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 149;BA.debugLine="PanelTop = 0";
_paneltop = (int) (0);
 //BA.debugLineNum = 150;BA.debugLine="IconTop = 12dip";
_icontop = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (12));
 //BA.debugLineNum = 152;BA.debugLine="Dim journeys As List = root.Get(\"journeys\")";
_journeys = new anywheresoftware.b4a.objects.collections.List();
_journeys.setObject((java.util.List)(_root.Get((Object)("journeys"))));
 //BA.debugLineNum = 153;BA.debugLine="Dim iterator As Int = 1";
_iterator = (int) (1);
 //BA.debugLineNum = 154;BA.debugLine="Dim LastIconTop As Int";
_lasticontop = 0;
 //BA.debugLineNum = 155;BA.debugLine="Dim IncrementBoxHeight As Int";
_incrementboxheight = 0;
 //BA.debugLineNum = 156;BA.debugLine="Dim BoxHeight As Int = 40dip";
_boxheight = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40));
 //BA.debugLineNum = 158;BA.debugLine="journeyPanel.AddView(referenceWrapper,30dip,Panel";
_journeypanel.AddView((android.view.View)(_referencewrapper.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)),_paneltop,(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))*2)),_boxheight);
 //BA.debugLineNum = 160;BA.debugLine="For Each coljourneys As Map In journeys";
_coljourneys = new anywheresoftware.b4a.objects.collections.Map();
final anywheresoftware.b4a.BA.IterableList group73 = _journeys;
final int groupLen73 = group73.getSize();
for (int index73 = 0;index73 < groupLen73 ;index73++){
_coljourneys.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(group73.Get(index73)));
 //BA.debugLineNum = 161;BA.debugLine="Dim journeyText As String = coljourneys.Get(\"tex";
_journeytext = BA.ObjectToString(_coljourneys.Get((Object)("text")));
 //BA.debugLineNum = 162;BA.debugLine="Dim rStatus As Int = coljourneys.Get(\"status\")";
_rstatus = (int)(BA.ObjectToNumber(_coljourneys.Get((Object)("status"))));
 //BA.debugLineNum = 164;BA.debugLine="progressBox.Initialize(\"\")";
_progressbox.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 166;BA.debugLine="journeyPanel.AddView(progressBox,30dip,PanelTop,";
_journeypanel.AddView((android.view.View)(_progressbox.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)),_paneltop,(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))*2)),_boxheight);
 //BA.debugLineNum = 169;BA.debugLine="Dim statusIcon As ImageView";
_statusicon = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 170;BA.debugLine="statusIcon.Initialize(\"\")";
_statusicon.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 171;BA.debugLine="statusIcon.Bitmap = LoadBitmap(File.DirAssets,\"c";
_statusicon.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"checked.png").getObject()));
 //BA.debugLineNum = 172;BA.debugLine="statusIcon.Gravity = Gravity.FILL";
_statusicon.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 173;BA.debugLine="journeyPanel.AddView(statusIcon,30dip-7.5dip,Ico";
_journeypanel.AddView((android.view.View)(_statusicon.getObject()),(int) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (7.5))),_icontop,anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (16)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (16)));
 //BA.debugLineNum = 176;BA.debugLine="Dim cd As ColorDrawable";
_cd = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 177;BA.debugLine="refStatus.Initialize(\"\")";
_refstatus.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 178;BA.debugLine="Select rStatus";
switch (_rstatus) {
case 0: {
 //BA.debugLineNum = 180;BA.debugLine="refStatus.Text = \"Qualifying\"";
_refstatus.setText((Object)("Qualifying"));
 //BA.debugLineNum = 181;BA.debugLine="cd.Initialize(Colors.RGB(249,191,55), 2dip)";
_cd.Initialize(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (249),(int) (191),(int) (55)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)));
 //BA.debugLineNum = 182;BA.debugLine="refStatus.Background = cd";
_refstatus.setBackground((android.graphics.drawable.Drawable)(_cd.getObject()));
 break; }
case 1: {
 //BA.debugLineNum = 184;BA.debugLine="refStatus.Text = \"1st Interview\"";
_refstatus.setText((Object)("1st Interview"));
 //BA.debugLineNum = 185;BA.debugLine="cd.Initialize(Colors.RGB(102,195,67), 2dip)";
_cd.Initialize(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (102),(int) (195),(int) (67)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)));
 //BA.debugLineNum = 186;BA.debugLine="refStatus.Background = cd";
_refstatus.setBackground((android.graphics.drawable.Drawable)(_cd.getObject()));
 break; }
default: {
 //BA.debugLineNum = 188;BA.debugLine="refStatus.Text = \"Completed\"";
_refstatus.setText((Object)("Completed"));
 //BA.debugLineNum = 189;BA.debugLine="cd.Initialize(Colors.RGB(22,176,221), 2dip)";
_cd.Initialize(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (22),(int) (176),(int) (221)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)));
 //BA.debugLineNum = 190;BA.debugLine="refStatus.Background = cd";
_refstatus.setBackground((android.graphics.drawable.Drawable)(_cd.getObject()));
 break; }
}
;
 //BA.debugLineNum = 193;BA.debugLine="refStatus.TextColor = Colors.White";
_refstatus.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 195;BA.debugLine="refStatus.Typeface = font.proximanovaSemiBold";
_refstatus.setTypeface((android.graphics.Typeface)(mostCurrent._font._proximanovasemibold().getObject()));
 //BA.debugLineNum = 196;BA.debugLine="refStatus.Gravity = Gravity.CENTER";
_refstatus.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 197;BA.debugLine="progressBox.AddView(refStatus,15dip,10dip,100dip";
_progressbox.AddView((android.view.View)(_refstatus.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (15)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)));
 //BA.debugLineNum = 200;BA.debugLine="refText.Initialize(\"\")";
_reftext.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 201;BA.debugLine="refText.Text = journeyText";
_reftext.setText((Object)(_journeytext));
 //BA.debugLineNum = 202;BA.debugLine="refText.Typeface = font.proximanovaRegular";
_reftext.setTypeface((android.graphics.Typeface)(mostCurrent._font._proximanovaregular().getObject()));
 //BA.debugLineNum = 203;BA.debugLine="progressBox.AddView(refText,refStatus.Left+refSt";
_progressbox.AddView((android.view.View)(_reftext.getObject()),(int) (_refstatus.getLeft()+_refstatus.getWidth()+_gap),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (_progressbox.getWidth()/(double)1.5),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 205;BA.debugLine="Dim TextHeight As Int";
_textheight = 0;
 //BA.debugLineNum = 206;BA.debugLine="TextHeight =  su.MeasureMultilineTextHeight(refT";
_textheight = mostCurrent._su.MeasureMultilineTextHeight((android.widget.TextView)(_reftext.getObject()),_reftext.getText());
 //BA.debugLineNum = 208;BA.debugLine="If BoxHeight < TextHeight Then";
if (_boxheight<_textheight) { 
 //BA.debugLineNum = 209;BA.debugLine="progressBox.Height = TextHeight + BoxHeight";
_progressbox.setHeight((int) (_textheight+_boxheight));
 };
 //BA.debugLineNum = 213;BA.debugLine="IconTop = IconTop + progressBox.Height + Gap";
_icontop = (int) (_icontop+_progressbox.getHeight()+_gap);
 //BA.debugLineNum = 214;BA.debugLine="PanelTop = PanelTop + progressBox.Height + Gap";
_paneltop = (int) (_paneltop+_progressbox.getHeight()+_gap);
 //BA.debugLineNum = 215;BA.debugLine="LastIconTop = statusIcon.Top";
_lasticontop = _statusicon.getTop();
 }
;
 //BA.debugLineNum = 218;BA.debugLine="journeyPanel.Height = PanelTop + scrollView.Top";
_journeypanel.setHeight((int) (_paneltop+mostCurrent._scrollview.getTop()));
 //BA.debugLineNum = 220;BA.debugLine="referenceWrapper.Height = LastIconTop";
_referencewrapper.setHeight(_lasticontop);
 //BA.debugLineNum = 221;BA.debugLine="DrawDashLine(referenceWrapper,0,0,0,referenceWrap";
...
anywheresoftware.b4a.objects.PanelWrapper _journeypanel = null;
anywheresoftware.b4a.objects.LabelWrapper _utiltextlabel = null;
 //BA.debugLineNum = 257;BA.debugLine="Sub showIcon_Click";
 //BA.debugLineNum = 258;BA.debugLine="Dim detailPanel,jobTitlePanel,journeyPanel As Pan";
_detailpanel = new anywheresoftware.b4a.objects.PanelWrapper();
_jobtitlepanel = new anywheresoftware.b4a.objects.PanelWrapper();
_journeypanel = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 259;BA.debugLine="Dim utilTextLabel As Label";
_utiltextlabel = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 261;BA.debugLine="detailPanel = detailList.Get(0)";
_detailpanel.setObject((android.view.ViewGroup)(mostCurrent._detaillist.Get((int) (0))));
 //BA.debugLineNum = 262;BA.debugLine="utilTextLabel = detailList.Get(1)";
_utiltextlabel.setObject((android.widget.TextView)(mostCurrent._detaillist.Get((int) (1))));
 //BA.debugLineNum = 263;BA.debugLine="jobTitlePanel = detailList.Get(2)";
_jobtitlepanel.setObject((android.view.ViewGroup)(mostCurrent._detaillist.Get((int) (2))));
 //BA.debugLineNum = 264;BA.debugLine="journeyPanel = detailList.Get(3)";
_journeypanel.setObject((android.view.ViewGroup)(mostCurrent._detaillist.Get((int) (3))));
 //BA.debugLineNum = 266;BA.debugLine="detailPanel.Height = detailPanel.Height + 100dip";
_detailpanel.setHeight((int) (_detailpanel.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100))));
 //BA.debugLineNum = 267;BA.debugLine="utilTextLabel.Top = detailPanel.Height";
_utiltextlabel.setTop(_detailpanel.getHeight());
 //BA.debugLineNum = 268;BA.debugLine="utilTextLabel.Text = \"Hide candidate details\"";
_utiltextlabel.setText((Object)("Hide candidate details"));
 //BA.debugLineNum = 269;BA.debugLine="jobTitlePanel.Top = utilTextLabel.Top + utilTextL";
_jobtitlepanel.setTop((int) (_utiltextlabel.getTop()+_utiltextlabel.getHeight()));
 //BA.debugLineNum = 270;BA.debugLine="scrollView.Top = jobTitlePanel.Top + jobTitlePane";
mostCurrent._scrollview.setTop((int) (_jobtitlepanel.getTop()+_jobtitlepanel.getHeight()));
 //BA.debugLineNum = 271;BA.debugLine="journeyPanel.Height = journeyPanel.Height + jobTi";
_journeypanel.setHeight((int) (_journeypanel.getHeight()+_jobtitlepanel.getTop()+_jobtitlepanel.getHeight()));
 //BA.debugLineNum = 273;BA.debugLine="showIcon.Visible = False";
mostCurrent._showicon.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 275;BA.debugLine="closeIcon.Top = detailPanel.Height - 5dip";
mostCurrent._closeicon.setTop((int) (_detailpanel.getHeight()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 276;BA.debugLine="closeIcon.Visible = True";
