...
innerInitialize(_ba);
 ...
 //BA.debugLineNum = 10;BA.debugLine="semiBold = Typeface.LoadFromAssets(\"fonts/proxima";
_semibold.setObject((android.graphics.Typeface)(__c.Typeface.LoadFromAssets("fonts/proximanova-semibold.ttf")));
 //BA.debugLineNum = 11;BA.debugLine="regular = Typeface.LoadFromAssets(\"fonts/proximan";
_regular.setObject((android.graphics.Typeface)(__c.Typeface.LoadFromAssets("fonts/proximanova-regular.ttf")));
 //BA.debugLineNum = 12;BA.debugLine="light = Typeface.LoadFromAssets(\"fonts/proximanov";
...
public anywheresoftware.b4a.keywords.constants.TypefaceWrapper  _proximanovalight() throws Exception{
 //BA.debugLineNum = 23;BA.debugLine="Public Sub proximanovaLight() As Typeface";
 //BA.debugLineNum = 24;BA.debugLine="Return light";
...
public anywheresoftware.b4a.keywords.constants.TypefaceWrapper  _proximanovaregular() throws Exception{
 //BA.debugLineNum = 19;BA.debugLine="Public Sub proximanovaRegular() As Typeface";
 //BA.debugLineNum = 20;BA.debugLine="Return regular";
...
public anywheresoftware.b4a.keywords.constants.TypefaceWrapper  _proximanovasemibold() throws Exception{
 //BA.debugLineNum = 15;BA.debugLine="Public Sub proximanovaSemiBold() As Typeface";
 //BA.debugLineNum = 16;BA.debugLine="Return semiBold";
