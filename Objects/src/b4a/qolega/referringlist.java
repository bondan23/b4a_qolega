...
public class referringlist extends Activity implements B4AActivity{
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.qolega", "b4a.qolega.referringlist");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.qolega.referringlist", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public b4a.qolega.auth _qauth = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 22;BA.debugLine="qAuth.Initialize(Activity)";
mostCurrent._qauth._initialize(mostCurrent.activityBA,mostCurrent._activity);
 //BA.debugLineNum = 26;BA.debugLine="Activity.AddMenuItem3(\"SearchItem\", \"SearchItem\",";
mostCurrent._activity.AddMenuItem3("SearchItem","SearchItem",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"search.png").getObject()),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 27;BA.debugLine="scrollView.Initialize(Activity.Height)";
mostCurrent._scrollview.Initialize(mostCurrent.activityBA,mostCurrent._activity.getHeight());
 //BA.debugLineNum = 28;BA.debugLine="scrollView.Color = Colors.RGB(219,219,219)";
mostCurrent._scrollview.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (219),(int) (219),(int) (219)));
 //BA.debugLineNum = 29;BA.debugLine="Activity.AddView(scrollView,0,0,100%x,100%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._scrollview.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 30;BA.debugLine="detailList.Initialize";
mostCurrent._detaillist.Initialize();
 //BA.debugLineNum = 31;BA.debugLine="LoopPanel";
_looppanel();
...
anywheresoftware.b4a.objects.LabelWrapper _detailbtn = null;
 //BA.debugLineNum = 198;BA.debugLine="Sub detailBtn_Click";
 //BA.debugLineNum = 199;BA.debugLine="For i = 0 To detailList.Size - 1";
{
final int step1 = 1;
final int limit1 = (int) (mostCurrent._detaillist.getSize()-1);
for (_i = (int) (0) ; (step1 > 0 && _i <= limit1) || (step1 < 0 && _i >= limit1); _i = ((int)(0 + _i + step1)) ) {
 //BA.debugLineNum = 200;BA.debugLine="Dim detailBtn As Label";
_detailbtn = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 201;BA.debugLine="detailBtn = detailList.Get(i)";
_detailbtn.setObject((android.widget.TextView)(mostCurrent._detaillist.Get(_i)));
 //BA.debugLineNum = 202;BA.debugLine="detailBtn = Sender";
_detailbtn.setObject((android.widget.TextView)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 }
};
 //BA.debugLineNum = 206;BA.debugLine="Test.userId = detailBtn.Tag";
mostCurrent._test._userid = (int)(BA.ObjectToNumber(_detailbtn.getTag()));
 //BA.debugLineNum = 207;BA.debugLine="StartActivity(Test)";
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper _r = null;
 //BA.debugLineNum = 211;BA.debugLine="Public Sub DrawBorder(Target As View, aColor As In";
 //BA.debugLineNum = 212;BA.debugLine="Dim c As Canvas";
_c = new anywheresoftware.b4a.objects.drawable.CanvasWrapper();
 //BA.debugLineNum = 213;BA.debugLine="c.Initialize(Target)";
_c.Initialize((android.view.View)(_target.getObject()));
 //BA.debugLineNum = 214;BA.debugLine="Dim r As Rect : r.Initialize(0, 0, Target.Width";
_r = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper();
 //BA.debugLineNum = 214;BA.debugLine="Dim r As Rect : r.Initialize(0, 0, Target.Width";
_r.Initialize((int) (0),(int) (0),_target.getWidth(),_target.getHeight());
 //BA.debugLineNum = 215;BA.debugLine="c.DrawRect(r, aColor, False, StrokeWidth)";
_c.DrawRect((android.graphics.Rect)(_r.getObject()),_acolor,anywheresoftware.b4a.keywords.Common.False,(float) (_strokewidth));
 //BA.debugLineNum = 216;BA.debugLine="Target.Invalidate";
_target.Invalidate();
...
mostCurrent._qauth = new b4a.qolega.auth();
...
String _rstatus = "";
int _userid = 0;
 //BA.debugLineNum = 35;BA.debugLine="Sub LoopPanel";
 //BA.debugLineNum = 36;BA.debugLine="Dim Bitmap1 As Bitmap";
_bitmap1 = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 37;BA.debugLine="Dim Container As Panel";
_container = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 38;BA.debugLine="Dim JoblistPanel,ReferencePanel As Panel";
_joblistpanel = new anywheresoftware.b4a.objects.PanelWrapper();
_referencepanel = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 39;BA.debugLine="Dim PanelTop,PanelHeight,ReferenceTop,ReferenceHe";
_paneltop = 0;
_panelheight = 0;
_referencetop = 0;
_referenceheight = 0;
_gap = 0;
_textheight = 0;
 //BA.debugLineNum = 40;BA.debugLine="Dim JobTitle,Location,JobDesc,Currency,Commision";
...
_commision = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 43;BA.debugLine="PanelTop = 10dip";
_paneltop = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10));
 //BA.debugLineNum = 45;BA.debugLine="PanelHeight = 110dip";
_panelheight = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110));
 //BA.debugLineNum = 47;BA.debugLine="Gap = 10dip";
_gap = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10));
 //BA.debugLineNum = 50;BA.debugLine="Container = scrollView.Panel";
_container = mostCurrent._scrollview.getPanel();
 //BA.debugLineNum = 51;BA.debugLine="Container.Color = Colors.RGB(219,219,219)";
_container.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (219),(int) (219),(int) (219)));
 //BA.debugLineNum = 54;BA.debugLine="JSON.Initialize(File.ReadString(File.DirAssets";
mostCurrent._json.Initialize(anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"list.json"));
 //BA.debugLineNum = 55;BA.debugLine="Dim root As List = JSON.NextArray";
_root = new anywheresoftware.b4a.objects.collections.List();
_root = mostCurrent._json.NextArray();
 //BA.debugLineNum = 56;BA.debugLine="For Each colroot As Map In root";
...
_colroot.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(group13.Get(index13)));
 //BA.debugLineNum = 58;BA.debugLine="Dim reference As List = colroot.Get(\"reference\")";
...
_reference.setObject((java.util.List)(_colroot.Get((Object)("reference"))));
 //BA.debugLineNum = 59;BA.debugLine="Dim job_title As String = colroot.Get(\"jobtitle\"";
_job_title = BA.ObjectToString(_colroot.Get((Object)("jobtitle")));
 //BA.debugLineNum = 60;BA.debugLine="Dim job_location As String = colroot.Get(\"locati";
_job_location = BA.ObjectToString(_colroot.Get((Object)("location")));
 //BA.debugLineNum = 61;BA.debugLine="Dim job_desc As String = colroot.Get(\"jobdesc\")";
_job_desc = BA.ObjectToString(_colroot.Get((Object)("jobdesc")));
 //BA.debugLineNum = 62;BA.debugLine="Dim job_commision As Double = colroot.Get(\"commi";
_job_commision = (double)(BA.ObjectToNumber(_colroot.Get((Object)("commision"))));
 //BA.debugLineNum = 65;BA.debugLine="JoblistPanel.Initialize(\"\")";
_joblistpanel.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 66;BA.debugLine="JobTitle.Initialize(\"JobTitle\")";
_jobtitle.Initialize(mostCurrent.activityBA,"JobTitle");
 //BA.debugLineNum = 67;BA.debugLine="Location.Initialize(\"Location\")";
_location.Initialize(mostCurrent.activityBA,"Location");
 //BA.debugLineNum = 68;BA.debugLine="JobDesc.Initialize(\"JobDesc\")";
_jobdesc.Initialize(mostCurrent.activityBA,"JobDesc");
 //BA.debugLineNum = 69;BA.debugLine="Currency.Initialize(\"Currency\")";
_currency.Initialize(mostCurrent.activityBA,"Currency");
 //BA.debugLineNum = 70;BA.debugLine="Commision.Initialize(\"Commision\")";
_commision.Initialize(mostCurrent.activityBA,"Commision");
 //BA.debugLineNum = 73;BA.debugLine="JobTitle.Text = job_title";
_jobtitle.setText((Object)(_job_title));
 //BA.debugLineNum = 74;BA.debugLine="Location.Text = job_location";
_location.setText((Object)(_job_location));
 //BA.debugLineNum = 75;BA.debugLine="Location.TextColor = Colors.RGB(179,179,179)";
_location.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (179),(int) (179),(int) (179)));
 //BA.debugLineNum = 76;BA.debugLine="JobDesc.Text = job_desc";
_jobdesc.setText((Object)(_job_desc));
 //BA.debugLineNum = 77;BA.debugLine="JobDesc.TextColor = Colors.RGB(179,179,179)";
_jobdesc.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (179),(int) (179),(int) (179)));
 //BA.debugLineNum = 78;BA.debugLine="Currency.Text = \"IDR \"&NumberFormat(job_commisio";
_currency.setText((Object)("IDR "+anywheresoftware.b4a.keywords.Common.NumberFormat(_job_commision,(int) (0),(int) (2))));
 //BA.debugLineNum = 79;BA.debugLine="Currency.Typeface = Typeface.DEFAULT_BOLD";
_currency.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD);
 //BA.debugLineNum = 80;BA.debugLine="Currency.TextColor = Colors.RGB(74,74,74)";
_currency.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (74),(int) (74),(int) (74)));
 //BA.debugLineNum = 81;BA.debugLine="Commision.Text = \"Commision\"";
_commision.setText((Object)("Commision"));
 //BA.debugLineNum = 82;BA.debugLine="Commision.TextColor = Colors.RGB(179,179,179)";
_commision.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (179),(int) (179),(int) (179)));
 //BA.debugLineNum = 85;BA.debugLine="JoblistPanel.AddView(JobTitle,10dip,10dip,100%x-";
_joblistpanel.AddView((android.view.View)(_jobtitle.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))*2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 86;BA.debugLine="TextHeight = su.MeasureMultilineTextHeight(JobTi";
_textheight = mostCurrent._su.MeasureMultilineTextHeight((android.widget.TextView)(_jobtitle.getObject()),_jobtitle.getText());
 //BA.debugLineNum = 88;BA.debugLine="JoblistPanel.AddView(Location,10dip,TextHeight+G";
_joblistpanel.AddView((android.view.View)(_location.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (_textheight+_gap),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 89;BA.debugLine="TextHeight = TextHeight + su.MeasureMultilineTex";
_textheight = (int) (_textheight+mostCurrent._su.MeasureMultilineTextHeight((android.widget.TextView)(_location.getObject()),_location.getText()));
 //BA.debugLineNum = 91;BA.debugLine="JoblistPanel.AddView(JobDesc,10dip,TextHeight+Ga";
...
_textheight = (int) (_textheight+mostCurrent._su.MeasureMultilineTextHeight((android.widget.TextView)(_jobdesc.getObject()),_jobdesc.getText()));
 //BA.debugLineNum = 94;BA.debugLine="JoblistPanel.AddView(Currency,10dip,TextHeight+G";
_joblistpanel.AddView((android.view.View)(_currency.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (_textheight+_gap),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 95;BA.debugLine="JoblistPanel.AddView(Commision,110dip,TextHeight";
_joblistpanel.AddView((android.view.View)(_commision.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),(int) (_textheight+_gap),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 96;BA.debugLine="TextHeight = TextHeight + su.MeasureMultilineTex";
_textheight = (int) (_textheight+mostCurrent._su.MeasureMultilineTextHeight((android.widget.TextView)(_currency.getObject()),_currency.getText()));
 //BA.debugLineNum = 98;BA.debugLine="JoblistPanel.Color=Colors.RGB(255,255,255)";
_joblistpanel.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 101;BA.debugLine="ReferenceTop = TextHeight+Gap*2";
_referencetop = (int) (_textheight+_gap*2);
 //BA.debugLineNum = 103;BA.debugLine="ReferenceHeight = 89dip";
_referenceheight = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (89));
 //BA.debugLineNum = 106;BA.debugLine="Dim SizeOfRef As Int = reference.Size";
_sizeofref = _reference.getSize();
 //BA.debugLineNum = 110;BA.debugLine="PanelHeight = PanelHeight+(ReferenceHeight*SizeO";
_panelheight = (int) (_panelheight+(_referenceheight*_sizeofref)+(_gap*_sizeofref));
 //BA.debugLineNum = 112;BA.debugLine="For Each colreference As Map In reference";
...
_colreference.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(group49.Get(index49)));
 //BA.debugLineNum = 113;BA.debugLine="Dim refName,refCompany,refStatus,detailBtn As L";
...
_detailbtn = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 114;BA.debugLine="Dim statusRef As String";
_statusref = "";
 //BA.debugLineNum = 115;BA.debugLine="Dim rHeight,statusRefColor As Int";
_rheight = 0;
_statusrefcolor = 0;
 //BA.debugLineNum = 118;BA.debugLine="Dim rName As String = colreference.Get(\"name\")";
_rname = BA.ObjectToString(_colreference.Get((Object)("name")));
 //BA.debugLineNum = 119;BA.debugLine="Dim rCompany As String = colreference.Get(\"comp";
_rcompany = BA.ObjectToString(_colreference.Get((Object)("company")));
 //BA.debugLineNum = 120;BA.debugLine="Dim rStatus As String = colreference.Get(\"statu";
_rstatus = BA.ObjectToString(_colreference.Get((Object)("status")));
 //BA.debugLineNum = 121;BA.debugLine="Dim userId As Int = colreference.Get(\"userId\")";
_userid = (int)(BA.ObjectToNumber(_colreference.Get((Object)("userId"))));
 //BA.debugLineNum = 124;BA.debugLine="ReferencePanel.Initialize(\"\")";
_referencepanel.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 125;BA.debugLine="ReferencePanel.Color = Colors.White";
_referencepanel.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 126;BA.debugLine="JoblistPanel.AddView(ReferencePanel,25dip,Refer";
_joblistpanel.AddView((android.view.View)(_referencepanel.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)),_referencetop,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (88),mostCurrent.activityBA),_referenceheight);
 //BA.debugLineNum = 127;BA.debugLine="DrawBorder(ReferencePanel,Colors.RGB(219,219,21";
_drawborder((anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_referencepanel.getObject())),anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (219),(int) (219),(int) (219)),(int) (4));
 //BA.debugLineNum = 130;BA.debugLine="refName.Initialize(\"\")";
_refname.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 131;BA.debugLine="refName.Text = rName";
_refname.setText((Object)(_rname));
 //BA.debugLineNum = 132;BA.debugLine="refName.TextColor = Colors.RGB(74,74,74)";
_refname.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (74),(int) (74),(int) (74)));
 //BA.debugLineNum = 133;BA.debugLine="refName.Typeface = Typeface.DEFAULT_BOLD";
_refname.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD);
 //BA.debugLineNum = 134;BA.debugLine="ReferencePanel.AddView(refName,10,10,ReferenceP";
_referencepanel.AddView((android.view.View)(_refname.getObject()),(int) (10),(int) (10),(int) (_referencepanel.getWidth()-_gap),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 135;BA.debugLine="rHeight = su.MeasureMultilineTextHeight(refName";
_rheight = mostCurrent._su.MeasureMultilineTextHeight((android.widget.TextView)(_refname.getObject()),_refname.getText());
 //BA.debugLineNum = 138;BA.debugLine="refCompany.Initialize(\"\")";
_refcompany.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 139;BA.debugLine="refCompany.Text = rCompany";
_refcompany.setText((Object)(_rcompany));
 //BA.debugLineNum = 140;BA.debugLine="refCompany.TextColor = Colors.RGB(0,0,0)";
_refcompany.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (0),(int) (0),(int) (0)));
 //BA.debugLineNum = 141;BA.debugLine="ReferencePanel.AddView(refCompany,10,rHeight+Ga";
_referencepanel.AddView((android.view.View)(_refcompany.getObject()),(int) (10),(int) (_rheight+_gap),(int) (_referencepanel.getWidth()-_gap),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 142;BA.debugLine="rHeight = rHeight + su.MeasureMultilineTextHeig";
_rheight = (int) (_rheight+mostCurrent._su.MeasureMultilineTextHeight((android.widget.TextView)(_refcompany.getObject()),_refcompany.getText()));
 //BA.debugLineNum = 145;BA.debugLine="Select rStatus";
switch (BA.switchObjectToInt(_rstatus,BA.NumberToString(0),BA.NumberToString(1))) {
case 0: {
 //BA.debugLineNum = 147;BA.debugLine="statusRef = \"Qualifying\"";
_statusref = "Qualifying";
 //BA.debugLineNum = 148;BA.debugLine="statusRefColor = Colors.RGB(249,191,55)";
_statusrefcolor = anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (249),(int) (191),(int) (55));
 break; }
case 1: {
 //BA.debugLineNum = 150;BA.debugLine="statusRef = \"1st Interview\"";
_statusref = "1st Interview";
 //BA.debugLineNum = 151;BA.debugLine="statusRefColor = Colors.RGB(102,195,67)";
_statusrefcolor = anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (102),(int) (195),(int) (67));
 break; }
default: {
 //BA.debugLineNum = 153;BA.debugLine="statusRef = \"Completed\"";
_statusref = "Completed";
 //BA.debugLineNum = 154;BA.debugLine="statusRefColor = Colors.RGB(22,176,221)";
_statusrefcolor = anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (22),(int) (176),(int) (221));
 break; }
}
;
 //BA.debugLineNum = 157;BA.debugLine="refStatus.Initialize(\"\")";
_refstatus.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 158;BA.debugLine="refStatus.Text = statusRef";
_refstatus.setText((Object)(_statusref));
 //BA.debugLineNum = 159;BA.debugLine="refStatus.TextColor = Colors.White";
_refstatus.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 160;BA.debugLine="refStatus.Color = statusRefColor";
_refstatus.setColor(_statusrefcolor);
 //BA.debugLineNum = 161;BA.debugLine="refStatus.Gravity = Gravity.CENTER";
_refstatus.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 162;BA.debugLine="ReferencePanel.AddView(refStatus,10dip,rHeight+";
_referencepanel.AddView((android.view.View)(_refstatus.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (_rheight+_gap+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))),(int) ((_referencepanel.getWidth()-_gap)/(double)2),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)));
 //BA.debugLineNum = 165;BA.debugLine="detailBtn.Initialize(\"detailBtn\")";
_detailbtn.Initialize(mostCurrent.activityBA,"detailBtn");
 //BA.debugLineNum = 166;BA.debugLine="detailBtn.Tag = userId";
_detailbtn.setTag((Object)(_userid));
 //BA.debugLineNum = 167;BA.debugLine="detailBtn.Text = \"Detail Progress\"";
_detailbtn.setText((Object)("Detail Progress"));
 //BA.debugLineNum = 168;BA.debugLine="detailBtn.TextColor = Colors.RGB(22,176,221)";
_detailbtn.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (22),(int) (176),(int) (221)));
 //BA.debugLineNum = 169;BA.debugLine="detailBtn.Gravity = Gravity.CENTER";
_detailbtn.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 172;BA.debugLine="detailList.Add(detailBtn)";
mostCurrent._detaillist.Add((Object)(_detailbtn.getObject()));
 //BA.debugLineNum = 174;BA.debugLine="ReferencePanel.AddView(detailBtn,((ReferencePan";
_referencepanel.AddView((android.view.View)(_detailbtn.getObject()),(int) (((_referencepanel.getWidth()-_gap)/(double)2)+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))),(int) (_rheight+_gap+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))),(int) ((_referencepanel.getWidth()-_gap)/(double)2),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)));
 //BA.debugLineNum = 176;BA.debugLine="ReferenceTop = ReferenceTop+ReferenceHeight+Gap";
_referencetop = (int) (_referencetop+_referenceheight+_gap);
 }
;
 //BA.debugLineNum = 179;BA.debugLine="Container.AddView(JoblistPanel,0,PanelTop,Contai";
_container.AddView((android.view.View)(_joblistpanel.getObject()),(int) (0),_paneltop,_container.getWidth(),_panelheight);
 //BA.debugLineNum = 180;BA.debugLine="PanelTop = PanelTop+PanelHeight+Gap";
_paneltop = (int) (_paneltop+_panelheight+_gap);
 //BA.debugLineNum = 181;BA.debugLine="PanelHeight = 110dip";
_panelheight = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110));
 }
;
 //BA.debugLineNum = 183;BA.debugLine="Container.Height = PanelTop";
...
public static String  _searchitem_click() throws Exception{
 //BA.debugLineNum = 186;BA.debugLine="Sub SearchItem_Click";
 //BA.debugLineNum = 187;BA.debugLine="qAuth.Logout";
