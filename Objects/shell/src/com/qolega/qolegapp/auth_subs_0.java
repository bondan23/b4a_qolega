...
if (true) return _su.runMethod(true,"EncodeBase64",(Object)(_bc.runMethod(false,"StringToBytes",(Object)(_tempstr),(Object)(RemoteObject.createImmutable("utf-8")))));
...
Debug.ShouldStop(2);
if (true) return __ref.getField(false,"_manager").runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("token")));
...
Debug.ShouldStop(32);
if (true) return __ref.getField(false,"_manager").runMethod(true,"GetString",(Object)(_index));
