...
public static b4a.qolega.testresponsive _testresponsive = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",test.mostCurrent._activity,"JSON",test.mostCurrent._json,"Main",Debug.moduleToString(b4a.qolega.main.class),"ReferringList",Debug.moduleToString(b4a.qolega.referringlist.class),"scrollView",test.mostCurrent._scrollview,"Starter",Debug.moduleToString(b4a.qolega.starter.class),"su",test.mostCurrent._su,"TestResponsive",Debug.moduleToString(b4a.qolega.testresponsive.class)};
}
}